...
void loop() {
  ...
  if (thresholdBroken(trigPin1, echoPin1)){
    ...
    US4 = 0;
    if(Current_Room==1){
      Serial.println("Grandma has left the chat");
      Current_Room=0;
    }
    
    else if(Current_Room==0){
      Serial.println("Grandma has entered the chat");
      Current_Room=1;
    }
  }
    ...
    US4 = 0;
    if(Current_Room==2){
      // Serial.println("Grandma in 1");
      Current_Room=1;

    }
    else if (Current_Room==1){
      // Serial.println("Grandma in 2");
      Current_Room=2;
    }
  }
